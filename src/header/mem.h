...
#define	_MEM_H
	...
	#define KERNERL_PAGE_DIC_ADDRESS	0x200000//定义内核内存表dic起始的物理地址,2m开始
	#define STATIC_MEM_LEN			0x800000//静态内存的长度
	//#define KERNERL_DUMP_SIZE		0x640000//堆内存的大小
	#define USESR_PROGRAM_STARTADDRESS	0x8000000
